...
X={
        'Lada1' : {'model':'2101', 'color':'Синий', 'age':'1997'},
        'Lada2' : {'model':'2101', 'color':'Синий', 'age':'1997'},
        'Chevrolet' : {'model':'aveo', 'color':'Красный',  'age':'2010'},
        'УАЗ' : {'model':'Патриот', 'color':'Серый', 'age':'2017'}
}
...
avtomobili = [
    ['lada'], ['model:2101', 'color:Синий', 'age:1997'],
    ['lada'], ['model:2101', 'color:Синий', 'age:1997'],
    ['Chevrolet'], ['model:aveo', 'color:Красный', 'age:2010'],
    ['УАЗ'], ['model:Патриот', 'color:Серый', 'age:2017'],
]
